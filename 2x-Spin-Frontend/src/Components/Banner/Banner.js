    ...
    <>
      <div style={{ padding: "0.5rem" }}>
        <div className="banner-container bg-banner section-box-shadow">
          <h2><b>Not just a game but an aim to use $WUT and Burn $WUT</b></h2>
          <h2>Post your win on twitter and get a chance to win upto 10k $WUT</h2>
          <h2>We burn 3% $WUT on each tx</h2>
