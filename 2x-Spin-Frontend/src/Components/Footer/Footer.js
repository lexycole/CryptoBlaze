    ...
    <>
      <div className="footer-container bg-[#D88331CC] py-6 mt-16 text-white rounded-tl-[18px] rounded-tr-[18px] header-box-shadow flex items-center justify-center">
        <div className="footer-socials flex flex-row gap-[0.75rem]">
          <a href="/" title="No discord MFERS" className="social-footer" target={"_blank"} rel="noreferrer">
            {/* <img src={Discord} alt="l"/> */}
            <svg
              stroke="currentColor"
              fill="currentColor"
              stroke-width="0"
          ...
          <a className="icons social-footer" href="https://twitter.com/WUTSpin" target={"_blank"} rel="noreferrer">
            {/* {" "}
            <img src={Twitter} alt="l"></img>{" "} */}
            <svg
